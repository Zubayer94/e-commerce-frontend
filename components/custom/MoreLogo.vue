<template>
  ...
  <svg :width="width" :height="height" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="4" y="4" width="16" height="16" rx="2" fill="#2F88FF" stroke="black" stroke-width="4"
        stroke-linejoin="round" />
    <rect x="4" y="28" width="16" height="16" rx="2" fill="#2F88FF" stroke="black" stroke-width="4"
        stroke-linejoin="round" />
    <rect x="28" y="4" width="16" height="16" rx="2" fill="#2F88FF" stroke="black" stroke-width="4"
        stroke-linejoin="round" />
